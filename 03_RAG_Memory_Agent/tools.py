tools = [
    ...
    #     "function": {
    #         "name": "Search",
    #         "description": "联网搜索工具。当你需要查询最新的股价、新闻、或者本地知识库中不存在的实时信息时使用。",
    #         "parameters": {
    #             "type": "object",
    #             "properties": {
...
#     """
#     通过联网搜索获取最新的实时信息、新闻或股价。
#     """
#     api_key = os.getenv("SEARCH_API_KEY")
#     url = os.getenv("SEARCH_API_BASE") + "/ai-search" # 假设是博查或类似的 API
    
#     headers = {"Authorization": f"Bearer {api_key}"}
#     payload = {
#         "query": query,
#         "freshness": "oneDay", # 只要最新的数据
#         "summary": True
#     }
    
#     try:
#         response = requests.post(url, json=payload, headers=headers)
#         # 不同的 API 返回结构不同，这里假设拿到的是文本摘要
#         result = response.json()
#         return result.get("data", {}).get("answer", "搜不到结果。")
